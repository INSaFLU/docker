...
mkdir /home/insaflu_web && cd /home/insaflu_web && git clone --branch metagenomics-ubuntu https://github.com/SantosJGND/INSaFLU.git && cd INSaFLU && pip3 install -r requirements.txt
if [ $? -ne 0 ]; then
